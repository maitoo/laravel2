...
@section('content')
    ...
    <table border="2" style="width: auto; margin: 10px 300px;">
        <tr><th>写真</th><th style="width=200px;">店名</th><th>都道府県</th><th>店の種類</th><th>住所</th><th>公開情報</th><th></th><th></th><th></th>
        </tr>
        ...
        {{--更新画面へ--}}
            <td style="border-top-style: hidden;"><a href="/company/edit?serial_number={{$item->serial_number}}">更新</a></td>   

        {{--削除画面へ--}}
            <td style="border-top-style: hidden;"><a href="/company/del?serial_number={{$item->serial_number}}">削除</a></td>

            <td style="border-top-style: hidden;"><a href="/company/find?serial_number={{$item->serial_number}}">詳細</a></td>
